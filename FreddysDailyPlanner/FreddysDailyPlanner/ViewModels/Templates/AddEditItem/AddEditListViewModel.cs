...
using FreddysDailyPlanner.Helpers;
using FreddysDailyPlanner.Helpers.Validations;
using FreddysDailyPlanner.Helpers.Validations.Rules;
...
namespace FreddysDailyPlanner.ViewModels.Templates.AddEditItem
{
