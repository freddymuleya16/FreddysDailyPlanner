...
using Prism.DryIoc;
using Prism.Ioc;
using FreddysDailyPlanner.Auth;
using FreddysDailyPlanner.Models;
using FreddysDailyPlanner.Repositories.FirestoreRepository;
using FreddysDailyPlanner.Services.DateService;
using FreddysDailyPlanner.ViewModels;
using FreddysDailyPlanner.ViewModels.Dialogs;
using FreddysDailyPlanner.ViewModels.Templates.AddEditItem;
using FreddysDailyPlanner.ViewModels.Templates.Auth;
using FreddysDailyPlanner.Views;
using FreddysDailyPlanner.Views.Dialogs;
using FreddysDailyPlanner.Views.Templates.AddEditItem;
using FreddysDailyPlanner.Views.Templates.Auth;
